...
<div class="navbar navbar-fixed-top navbar-default" role="navigation">
    ...
    <div class="row clearfix banner">
        <div class="col-md-12 column" >
            <br><br>
            <!--主表-->
            <div class="jumbotron container" style="width:900px;text-align: end">
                ...
                <a class="button button-rounded button-border" href="../../function/bed/"><strong>病床管理入口</strong></a>
                <a type="submit" class="button button-primary button-rounded button-border" data-toggle="modal" data-target="#add"><strong>新增患者登记</strong></a>
                                ...
                                <div id="wrapper" class="login-page">
                                    <div id="login_form" class="form">
                                        ...
                                        <form class="login-form" action="patients.php" method="post">
                                            ...
                                            <input type="text" id="patient_gender" name="patient_gender" placeholder="病人性别"/>
